    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-3xl group-data-[variant=floating]:shadow-xl group-data-[variant=floating]:shadow-black/5 group-data-[variant=floating]:ring-1 flex size-full flex-col overflow-hidden"
        >
          {children}
        </div>
      </div>
